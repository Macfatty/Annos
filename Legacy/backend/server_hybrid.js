...
app.get("/api/menu/restaurants", MenuController.getRestaurants);

// Hämta meny för specifik restaurang
app.get("/api/menu/:slug", MenuController.getMenu);

// Hämta tillbehör för specifik restaurang
app.get("/api/menu/:slug/accessories", MenuController.getAccessories);

// Sök i meny
app.get("/api/menu/:slug/search", MenuController.searchMenu);

// Hämta kategorier
app.get("/api/menu/:slug/categories", MenuController.getCategories);

// Hämta meny efter kategori
app.get("/api/menu/:slug/category/:category", MenuController.getMenuByCategory);

// Hämta specifik meny-item
app.get("/api/menu/:slug/item/:itemId", MenuController.getMenuItem);

// Hämta tillbehör efter typ
app.get("/api/menu/:slug/accessories/type/:type", MenuController.getAccessoriesByType);

// Hämta grupperade tillbehör
app.get("/api/menu/:slug/accessories/grouped", MenuController.getGroupedAccessories);

// ========================================
// GAMLA MENY-ENDPOINTS (FÖR BAKÅTKOMPATIBILITET)
// ========================================

// Hämta meny-data (gamla endpoints)
...
// Hämta tillbehör-data (gamla endpoints)
